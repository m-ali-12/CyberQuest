...
import { Shield, Terminal, Lock, ChevronRight, Flag } from 'lucide-react';
...
const catIcon: Record<string, string> = {
  CRYPTO: '🔐', WEB: '🌐', STEGO: '🖼️', NETWORK: '📡', OSINT: '👁️', REVERSE: '⚙️', FORENSICS: '🔍',
};
...
export default function PublicChallengesPage() {
  return (
    <div className="min-h-screen bg-cyber-dark cyber-grid">
      {/* Nav */}
      <nav className="border-b border-cyber-border bg-cyber-dark/90 backdrop-blur-xl px-6 py-4 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-4 gap-4 mb-10">
          {[
            { label: 'Total Challenges', value: '200+' },
            { label: 'Categories', value: '8' },
            { label: 'Hackers', value: '12,400+' },
        ...
        {/* Locked overlay CTA */}
        <div className="relative cyber-card rounded-2xl p-10 border border-cyber-green/20 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-display font-bold text-white mb-2">
              196 More Challenges Await
            </h2>
            <p className="text-gray-400 font-mono mb-6 max-w-md mx-auto">
              Create a free account to access 20+ challenges instantly. Upgrade to Pro for all 200+.
            </p>
            <div className="flex gap-3 justify-center flex-wrap">
              <Link href="/register" className="btn-cyber-solid px-8 py-3 rounded-xl text-sm font-bold inline-flex items-center gap-2">
                Start Free — 20 Challenges <ChevronRight className="w-4 h-4" />
              </Link>
